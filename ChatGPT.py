...
class ChatGPT(loader.Module):
    strings = {
        "name": "ChatGPT",
        "chatgpt": "<b><emoji document_id=5372981976804366741>🤖</emoji> ChatGPT: </b>",
    ...
    async def gptcmd(self, message: Message):
        ...
        await utils.answer(message, self.strings("chatgpt") + response + self.strings("quest").format(args=args))
